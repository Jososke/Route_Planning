...
{    
    ...
    //(0,0) is bottom left hand corner of the map (100,100) is top right of the map
    float start_x, start_y, end_x, end_y;
    std::cout << "Enter Map coordinates between (0,0) and (100, 100) \n";
    ...
    std::cout << "Distance in meters: "<< route_planner.GetDistance() << "\n";
    Render render{model};
